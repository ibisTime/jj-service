...
import com.cdkj.service.dto.req.CD612110Req;
...
public class CD612110 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        condition.setType(EIntentionType.FW.getCode());
        ...
        return intiontAO.queryFWIntentionPage(start, limit, condition);
    }

    @Override
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, CD612110Req.class);
