...
public class ServeTrainDAOImpl extends AMybatisTemplate implements
        IServeTrainDAO {
    ...
    public ServeTrain select(ServeTrain condition) {
        return super.select(NAMESPACE.concat("select_serveTrain"), condition,
            ServeTrain.class);
    }
    ...
    public Long selectTotalCount(ServeTrain condition) {
        return super.selectTotalCount(
            NAMESPACE.concat("select_serveTrain_count"), condition);
    }

    @Override
    public List<ServeTrain> selectList(ServeTrain condition) {
        return super.selectList(NAMESPACE.concat("select_serveTrain"),
            condition, ServeTrain.class);
    }

    @Override
    public List<ServeTrain> selectList(ServeTrain condition, int start,
            int count) {
        return super.selectList(NAMESPACE.concat("select_serveTrain"), start,
            count, condition, ServeTrain.class);
    }
