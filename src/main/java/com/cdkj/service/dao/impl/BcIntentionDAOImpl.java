...
public class BcIntentionDAOImpl extends AMybatisTemplate implements IBcIntentionDAO {
	...
	public BcIntention select(BcIntention condition) {
		return super.select(NAMESPACE.concat("select_bcIntention"), condition,BcIntention.class);
	}


	@Override
	public Long selectTotalCount(BcIntention condition) {
		return super.selectTotalCount(NAMESPACE.concat("select_bcIntention_count"),condition);
	}


	@Override
	public List<BcIntention> selectList(BcIntention condition) {
		return super.selectList(NAMESPACE.concat("select_bcIntention"), condition,BcIntention.class);
	}


	@Override
	public List<BcIntention> selectList(BcIntention condition, int start, int count) {
		return super.selectList(NAMESPACE.concat("select_bcIntention"), start, count,condition, BcIntention.class);
	}
