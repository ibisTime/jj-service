...
import com.xnjr.mall.dto.req.XNpt4000Req;
import com.xnjr.mall.dto.res.XNpt4000Res;
 ...
 * @history:
 */
public class XNpt4000 extends AProcessor {

    private IPTCompanyCardAO ptCompanyCard = SpringContextHolder
        .getBean(IPTCompanyCardAO.class);

    private XNpt4000Req req = null;
    ...
    public Object doBusiness() throws BizException {
        ...
        return new XNpt4000Res(ptCompanyCard.addPTCompanyCard(data));
    }
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XNpt4000Req.class);
