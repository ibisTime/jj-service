...
import com.xnjr.mall.dto.req.XNpt2002Req;
import com.xnjr.mall.dto.res.XNpt2002Res;
 ...
 * 修改平台公司信息
 * @author: haiqingzheng 
 * @since: 2016年3月4日 下午9:57:07 
 * @history:
 */
public class XNpt2002 extends AProcessor {
    private IPTCompanyAO ptCompanyAO = SpringContextHolder
        .getBean(IPTCompanyAO.class);

    private XNpt2002Req req = null;
    ...
    public Object doBusiness() throws BizException {
        ...
        ptCompanyAO.editPTCompany(data);
        return new XNpt2002Res(true);
    }
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XNpt2002Req.class);
        StringValidater.validateBlank(req.getCode(), req.getZwName(),
            req.getYwName(), req.getZcAddress(), req.getJyAddress(),

            req.getCurrency(), req.getCapital(), req.getFrPerson(),
            req.getGdPerson(), req.getCwPerson(),

            req.getDebdtxPerson(), req.getWyRecorder(), req.getWyChecker(),
            req.getTelephone());
    }
}
