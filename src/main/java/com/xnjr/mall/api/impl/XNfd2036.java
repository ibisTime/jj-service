...
import com.xnjr.mall.dto.req.XNfd2036Req;
...
public class XNfd2036 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return fdCompanyAO.queryCompanyList(condition);
    }

    @Override
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XNfd2036Req.class);
    }
}
