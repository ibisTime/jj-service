...
import com.xnjr.mall.dto.req.XN602402Req;
...
public class XN602402 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return new BooleanRes(merCardAO.editMerCard(data) > 0 ? true : false);
    }
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN602402Req.class);
        StringValidater.validateBlank(req.getCode(), req.getCompanyCode(),
            req.getSubbranch(), req.getCardNo(), req.getStatus(),
            req.getUpdater());
    }
}
